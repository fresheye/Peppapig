    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1Button.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                ...
                intent.setClass(GameModeActivity.this, PlayerActivity.class);
                SysApplication.getInstance().addActivity(GameModeActivity.this);
        ...
        t2Button.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent();
                intent.setClass(GameModeActivity.this, ChooseRoleActivity.class);
                SysApplication.getInstance().addActivity(GameModeActivity.this);
                GameModeActivity.this.startActivity(intent);
            }
        });
